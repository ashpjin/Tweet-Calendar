  ...
  <body>
  	...
  	<table >
  		<tr>
			...
			<form name="search_term" action="leaf_script.php" method="post">
	...
	<div id="chart"></div>
	<script type="text/javascript">var term = "<?= $search_id ?>";</script>
	<script type="text/javascript" src="leaf_dji.js"></script>
  </body>
</html>
