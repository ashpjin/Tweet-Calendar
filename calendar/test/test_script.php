...
<html>
  <head>
    ...
    <link type="text/css" rel="stylesheet" href="test_calendar.css"/>
  </head>
  <body>

  	<table >
  		<tr>
  			<td><h2>Percentage of Tweets Per Day Containing "Leafing Out<?php //echo $search_term; ?>"</h2></td>
  			<td width="200px" align="right"><b>Choose New Term:</b></td>
			<form name="search_term" action="test_script.php" method="post">
	...
	<!--<div id="axis_labels"></div>-->	
	<div id="chart"></div>
	<script type="text/javascript" src="test_stuff.js"></script>
  </body>
</html>
